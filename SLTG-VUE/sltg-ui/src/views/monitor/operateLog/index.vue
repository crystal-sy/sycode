    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['monitor:operateLog:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['monitor:operateLog:export']"
        >导出</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['monitor:operateLog:query']"
          >详细</el-button>
        </template>
      </el-table-column>
    </el-table>
      ...
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          <el-col :span="12">
            ...
            <el-form-item
              label="登录信息："
            >{{ form.operateName }} / {{ form.operateIp }} / {{ form.operateLocation }}</el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { list, delOperateLog, cleanOperateLog, exportOperateLog } from "@/api/monitor/operateLog";
